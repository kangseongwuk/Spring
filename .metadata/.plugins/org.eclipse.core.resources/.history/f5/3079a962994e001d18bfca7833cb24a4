...
----------------------------------------
 ...
 - @Required : 반드시 주입해야 할 프로퍼티로 설정합니 다.     
 ...
 - @Autowired : 객체 타입을 통하여 bean 객체를 자동으로 주입해 줍니다.
  ...
  @Qualifier : @Autowired로 주입할 경우에 타입의 Bean이 여러개인 경우에는 Qualifier에 설정 되어 있는 빈을  찾아서 주입을 합니다.
...
public class mainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("----------xml1 area------------------");
		  ...
		  System.out.println(t2);// address value System.out.println(t2.getData1());//
		  System.out.println(t2.getData1());// 임성찬
		  System.out.println(t2.getData2());// 123.456
...
//		  System.out.println(java4.getData1());// null =>
//		  System.out.println(java4.getData2());// null =>
